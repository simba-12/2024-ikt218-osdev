...
extern Song music_1_song;
extern Song starwars_theme_song;
extern Song battlefield_1942_theme_song;
//extern Song* songs[];
//extern unsigned int n_songs;
...
// Array of pointers to Song structs
